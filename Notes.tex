...
\subsection{. Special forms of 1$^{st}$ law of thermodynamics}
...
From Eq.\myeqref{eq:C_pdT=adp}, Eq.\myeqref{eq:dTdz=dtdpdpdz} and Eq.\myeqref{eq:dPdz}
\begin{align}
...
\begin{align}
    ...
    T_1\cdot\eta_{\text{rev}} = T_1 - T_2 \label{eq:eff_of_heat_engine}
\end{align}
...
\end{align}
Using hydrosattic equation/approximation Eq.\myeqref{eq:hydrostatic_eq};
\begin{align}
...
\begin{enumerate}[noitemsep]
    \item Homgeneous : Involve forign particles (aerosols), CNN (Cloud Condensation Nuclei)
    \item Hetrogeneous
\end{enumerate}
...
\begin{align}
    ...
    R^* &= \frac{2\sigma}{nKT\ln\big(\frac{e}{e_s}\big)} \label{eq:kelvins_eq}
\end{align}
Eq.\myeqref{eq:kelvins_eq} is called \textbf{Kelvin's equation}
...
\begin{figure}[ht]
    ...
    \begin{tikzpicture}
        ...
        \draw[thick] (1,1) circle(0.2) node {1};
        \draw[thick] (1,0.3) circle(0.2) node {2};
    \end{tikzpicture}
\end{figure}
...
\begin{enumerate}
    ...
    \begin{figure}[ht]
        ...
        \begin{tikzpicture}
            ...
            \draw[dotted, thick] (0,0.7) circle(0.7);
            \draw[->, blue, thick] (0, 1) -- (0, 2) node[midway, left] {Eva};
    ...
    \begin{figure}[ht]
        \centering
        \begin{tikzpicture}
            \draw[thick] (1.25, 0) -- (3.75, 0);
            \draw[thick] (2.5,0) circle(0.7);
            \draw[->, blue, thick] (2.3, 0.8) -- (2.3, 1.8) node[midway, left] {Eva};
            \draw[->, blue, thick] (2.7, 1.8) -- (2.7, 0.8) node[midway, right] {Con};
        \end{tikzpicture}
    \end{figure}
\end{enumerate}
