...
\Authors{Harshit Prahant Dhanwalkar (SC21B164)\textsuperscript{1}*} % Authors
\affiliation{\textsuperscript{1}\textit{MTech, Earth Sciences System (ESS), 1$^{st}$ year, Department of Physics, Indian Institute Of Spacescience and Technology (IIST)}} % Author affiliation
...
Let $L$ is latent heat associated with phase change of a liquid to vapor:
\begin{align}
    L &= \int dq \\
