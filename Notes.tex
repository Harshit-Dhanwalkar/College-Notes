...
\begin{tikzpicture}[
    ...
    sibling distance=0.25cm, level distance=0.5cm,
    level 1/.style={sibling distance=1.75cm, level distance=3.25cm}, 
    level 2/.style={sibling distance=0.5cm, level distance=2cm},
    grow=right
]
    \node {Cloud Classification}
        child { node {Composition}
        ...
        \begin{tikzpicture}
            \begin{axis}[
                ...
                \addplot[domain=0.1:5, samples=100, fill=blue, opacity=0.2] 
                    {max(0, x} \closedcycle;
                % \addplot[domain=0.1:5, samples=100, fill=blue, opacity=0.3] 
...
\begin{tikzpicture}
    \begin{axis}[
        ...
        {exp(-x)}; % Corrected the expression for e^-x
        \addlegendentry{$\Delta E$}; % Legend entry
