...
\begin{figure}[ht]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot[blue!80, dashed] coordinates {(-7.5, 5.5) (-7.5, 0)};
            \addplot[black!80, dashed] coordinates {(-3.6, 5.65) (-15, 5.65)};
            % Intersection point of the two lapse rates
            \addplot[black, dashed] coordinates {(0, 5) (0, 0)};
            % Markers at the intersection and arbitrary points
            \addplot[mark=*] coordinates {(-7, 5.7)} node[above] {$B$}; % Point A on Dry Adiabatic
            \addplot[mark=*] coordinates {(-3.6, 5.7)} node[above] {$A$}; % Point B on Moist Adiabatic
            \addplot[mark=*] coordinates {(0, 5)} node[above] {$O$}; % Intersection point O
            % Labels for Dry and Moist Adiabatic Lapse Rates
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{Height vs Temperature for Dry and Moist Adiabatic Lapse Rates}
\end{figure}
where,\vspace{-0.2cm}
\begin{align*}
...
\begin{figure}[ht]
    ...
    \end{tikzpicture}
\end{figure}
% FIX: above 2 plots/figures
% WARN: INCOMPLETE L-26
% --------------------------------------------------------------------------------------
\clearpage
% \begin{tikzpicture}
%     [tdplot_main_coords,
