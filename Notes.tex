...
% FIX: add Skew-T diagram to show T_d \leq T_w \leq T
\begin{figure}[ht!]
    \centering
    \begin{tikzpicture}
        \begin{axis}[
            ...
            every axis y label/.style={at={(axis description cs:0.1,1.05)},anchor=south},
            every axis x label/.style={at={(axis description cs:1.05,0.05)},anchor=west},
        ]

        % Plot constant isobars at 1000 hPa and 900 hPa
        \addplot[dashed, color=black] coordinates {(-20, 1000) (40, 1000)} node[pos=0.95, anchor=south west] {1000 hPa};
        \addplot[dashed, color=black] coordinates {(-20, 900) (40, 900)} node[pos=0.95, anchor=south west] {900 hPa};

        % Plot dry adiabat (straight line)
        \addplot[thick, color=red] coordinates {(-10, 1000) (10, 900)} node[pos=0.5, anchor=north east] {Dry Adiabat};

        % Plot moist adiabat (curved line)
        \addplot[thick, color=blue, domain=-10:20, samples=100] 
            {1000 - (100 * ln(1 + 0.02 * (x + 10)))}
            node[pos=0.7, anchor=south east] {Moist Adiabat};

        % Add legend
        \legend{Isobars, Dry Adiabat, Moist Adiabat}
        
        \end{axis}
    \end{tikzpicture}
    \caption{Atmospheric Diagram with Isobars, Dry and Moist Adiabat}
\end{figure}
...
\begin{figure}[ht]
    ...
    \begin{tikzpicture}
        ...
        \addplot[thick, color=orange!90] coordinates {(15, 900) (10, 1000)}
            node[pos=0.7, anchor=south, xshift=35, yshift=-20] {Dry Adiabat}
            node[pos=0, anchor=south, xshift=2, yshift=-15] {$T$};
        \addplot[dashed, color=red] coordinates {(5, 1100) (10, 1000)};
...
Because the environment is in hydrostatic equlibrium given by Eq\myeqref{eq:hyfrostatic_eq}
...
Using Ideal gas equation,
\begin{align}
    \frac{d^2z}{dt^2} &= \Big(\frac{T_v'- T_v}{T_v}\Big)g
\end{align}
